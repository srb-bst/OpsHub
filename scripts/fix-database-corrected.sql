...
-- Insert sample design projects (MUST happen after customers)
INSERT INTO design_projects (id, customer_id, title, status, project_type, area) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'Taylor Front Yard Redesign', 'needs-estimate', 'residential', 'Front Yard'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '22222222-2222-2222-2222-222222222222', 'Anderson Backyard Renovation', 'needs-estimate', 'residential', 'Back Yard'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-3333-3333-3333-333333333333', 'Johnson Patio Installation', 'needs-estimate', 'residential', 'Patio'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', '44444444-4444-4444-4444-444444444444', 'Martinez Garden Design', 'pending-approval', 'residential', 'Full Property');

-- Insert sample estimate (MUST reference existing design_project_id)
...
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'EST-2025-001', 'Sarah Martinez', 'Martinez Garden Design', 'draft', 15750.00, 12000.00, 3000.00, 750.00);
